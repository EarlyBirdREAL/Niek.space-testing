...
export default {
  ...
  data() {
      return {
        ...
        track: findItem(this.$route.params.song)
      }

  },
  methods: {
    test() {
      data = findItem(this.$route.params.song)
      if (data) {
...
<template>
  <img src="../../public/images/hold-me-now-background.png" alt="Album cover" class="background">
  <div class="frame">
    <img :src=track.coverURL alt="ALBUM COVER" class="test"/>
    <div class="card">
